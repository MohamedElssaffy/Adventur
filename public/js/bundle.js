      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.prev = 1;
            _context.next = 4;
            return (0, _axios.post)("/api/v1/users/login", {
              email: email,
              password: password
            });
          ...
          case 4:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Log in Successfuly");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            _context2.next = 3;
            return (0, _axios.patch)("/api/v1/users/logout");
          ...
          case 7:
            ...
            (0, _alerts.showAlert)("error", "Cant Log out Please try again");
...
var signUp = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(data, btn) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0, _axios.post)("/api/v1/users/signup", data);
          ...
          case 8:
            ...
            (0, _alerts.showAlert)("error", "Email is Already Taken");
...
var stripe = function stripe() {
  return Stripe("pk_test_51IrZdcAxUj6rVyviAJNHWEWcyrbGoN0ymEJVEE248vLM0j35gCxujloQOPYGIru2g3tC5i1Ae4t0wCNlhyQmA6UW00BaodFuNa");
};
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.get)("http://localhost:3000/api/v1/booking/checkout-session/".concat(tourId));
...
var updateStting = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return (0, _axios.patch)("http://localhost:3000/api/v1/users/update".concat(type), data);

          case 3:
            res = _context.sent;

            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Data is updated successfuly");
            }
  ...
  return function updateStting(_x, _x2) {
    return _ref.apply(this, arguments);
  };
}();

exports.updateStting = updateStting;
...
// Dom Elements
var singUpForm = document.querySelector(".sign-up .form");
...
if (singUpForm) {
  singUpForm.addEventListener("submit", function (e) {
    ...
    if (password !== passwordConfirm) {
      btn.removeAttribute("disabled");
      return (0, _alerts.showAlert)("error", "Password Should Match");
    }
...
if (updateForm) {
  updateForm.addEventListener("submit", function (e) {
    ...
    (0, _updateUser.updateStting)(form, "me");
  });
}
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              e.preventDefault();
              document.querySelector(".form-user-password .btn").textContent = "...updatting";
              ...
              _context.next = 7;
              return (0, _updateUser.updateStting)({
            ...
            case 7:
              document.querySelector(".form-user-password .btn").textContent = "Update Password";
...
},{"./alerts":"alerts.js","./login":"login.js","./mapbox":"mapbox.js","./sign-up":"sign-up.js","./stripe":"stripe.js","./updateUser":"updateUser.js"}],"../../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
